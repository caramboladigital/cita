...
--
-- Host: 127.0.0.1
-- Tempo de geração: 09/11/2020 às 17:25
...
(187, 'BERTALANFFY', 'Ludwig von'),
(188, 'MAU', 'Bruce'),
(189, 'SÓFOCLES', ''),
(190, 'EURÍPIDES', ''),
(191, 'ÉSQUILO', ''),
(192, 'ARISTÓFANES', ''),
(195, 'ABRACADABRA', 'Álvaro');
...
(1, 1, '9', 'Encontramos hoje, com efeito, dentro das massas, duas tendências igualmente fortes: exigem, de um lado, que as coisas se lhe tornem, tanto humana como espacialmente, \'mais próximas\', de outro lado, acolhendo as reproduções, tendem a depreciar a caráter daquilo que é dado apenas uma vez.', NULL),
(2, 1, '10', 'A unicidade da obra de arte não difere de sua integração nesse conjunto de afinidades que se denomina tradição. (...) trata- se de um fato de importancia decisiva a perda necessária de sua aura, quando, na obra de arte, não resta mais nenhum vestígio de sua função ritualística.', NULL),
(3, 1, '10', 'o valor da obra como objeto de culto e o seu valor como realidade exibível.', NULL),
(4, 2, '16', 'No século XX, (...) o processo de modernização se expande a ponto de abarcar virtualmente o mundo todo, e a cultura mundial do modernismo em desenvolvimento atinge espetaculares triunfos na arte e no pensamento. Por outro lado, à medida que se expande, o público moderno se multiplica em uma multidão de fragmentos, que falam linguagem incomesuravelmente confidenciais; a idéia de modernidade, concebida em inúmeros e fragmentários caminhos, perde muito de sua nitidez, ressonância e profundidade e perde sua capacidade de organizar e dar sentido à vida das pessoas.', NULL),
(5, 2, '21', 'A moderna humanidade se vê em meio a uma enorme ausência e vazio de valores, mas, ao mesmo tempo, em meio a uma desconcertante abundância de possibilidades.', NULL),
(6, 2, '23', '(...) não sabemos como usar nosso modernismo; nós perdemos ou rompemos a conexão entre nossa cultura e nossas vidas.', NULL),
(7, 2, '34', 'iluminar as forças contraditórias (...) que nos atormentam: nosso desejo de nos enraizarmos em um passado social e pessoal coerente e estável, e nosso insaciável desejo de crescimento -- crescimento que destrói as paisagens físicas e sociais do nosso passado e nossos vínculos emocionais com esses mundos perdidos; (...) nosso desejo de sólidos e claros valores em função dos quais viver e nosso desejo de abarcar todas as ilimitadas possibilidades de vida e experiência modernas, que oblitera todos os valores.', NULL),
(8, 2, '35', 'Nós -- os pensadores atuais -- perdemos o controle sobre as contradições que eles -- os \'antigos pensadores modernos\' -- tiveram que agarrar com toda força, a todo momento, em suas vidas cotidianas, para poderem sobreviver, afinal.', NULL),
(9, 2, '42', 'O que leva Fausto a sentir seus triunfos como lixo é que, até esse momento, foram apenas conquistas da vida interior, apenas espiritualidade. Ao longo dos anos, através da meditação e da experimentação, através dos livros e das drogas -- ele é um humanista na acepção verdadeira; nada do que é humano lhe é estranho --, ele fez tudo o que pode para aperfeiçoar sua capacidade de pensar, sentir e ver. Apesar disso, quanto mais sua mente se expandiu, quanto mais aguda se tornava sua sensibilidade, mais ele se isolou e mais pobre se tornaram suas relações com o mundo exterior -- suas relações com outras pessoas, com a natureza, até mesmo com suas próprias necessidades e forças ativas. Sua cultura se desenvolveu nosentido de divorciá-lo da totalidade da vida.', NULL),
(10, 2, '69', 'Ironicamente, assim que esse fomentador conseguiu destruir o mundo pré-moderno, destruiu também qualquer razão para continuar no mundo (...) Tão logo se livra de todos os obstáculos no Caminho, o fomentador vê a si próprio no meio do caminho e deve ser afastado.', NULL),
(11, 2, '88', '(o autor citando Marx)<br>Tudo o que é sólido desmancha no ar, tudo o que é sagrado é profanado; e os homens são finalmente forçados a enfrentar com sentidos mais sóbrios suas reais condições de vida e suas relações com outros homens.', NULL),
(12, 2, '88', 'A segunda cláusula, de acordo com a qual se destrói tudo o que é sagrado, é mais complexa e interessante do que a convencional assertiva materialista do século XIX segundo a qual Deus não existe. Marx se move na dimensão do tempo, tentando evocar o próprio curso de um drama e um trauma históricos. Ele diz que a aura de santidade subitamente se ausenta e que não podemos compreender a nós mesmos no presente sem nos confrontarmos com essa ausência.', NULL),
(13, 3, '', 'Opondo-se ao logos, \"como a fantasia à razão, como a palavra que narra à que demonstra\", logos e mytos são as duas metades da linguagem, duas funções igualmente fundamentais da vida e do espírito. O logos, sendo um raciocínio, procura convencer, acarretando no ouvinte a necessidade de julgar. O logos é verdadeiro se é correto e conforme a lógica; é falso, se dissimula alguma burla secreta (um \"sóphisma\"). O mito, porém , não possui outro fim senão a si próprio. Acredita-se nele ou não, à vontade, por um ato de fé, se o mesmo parece \"belo\" ou verossímil, ou simplesmente porque se deseja dar-lhe crédito. Assim é que o mito atrai, em torno de si, toda a parte do irracional no pensamento humano, sendo, por sua própria natureza, aparentado à arte, em todas as suas criações.', ''),
(14, 3, '11', 'Foi nesta convivência entre religião, alquimia, astrologia e superstição que nasceu o humanismo europeu, útero e berço da ciência moderna.', NULL),
(15, 3, '25', 'Os mitos gregos só se conhecem através da forma escrita e das imóveis composições da arte figurada, o que, aliás, é comum a quase todas as mitologias antigas. Ora, a forma escrita desfigura, por vezes, o mito de algumas de suas características básicas, como, por exemplo, de suas variantes, que se constituem no verdadeiro pulmão da mitologia. Com isso, o mito se enrijece e se fixa numa forma definitiva. De outro lado, a forma escrita o distancia do momento da narrativa, das circunstancias e da maneira como aquela se converteria numa ação sagrada. Um mito escrito está para um mito \"em função\", como uma fotografia está para uma pessoa viva.', NULL),
(16, 3, '26', 'É claro que houve, na Grécia, um liame muito forte entre literatura, arte figurativa e religião, mas, ao plasmar o material mitológico, os poetas e artistas gregos não obedeciam tão-somente a critérios religiosos, mas também, e isso é fácil de se perceber, a ditames estéticos. Toda obra de arte, como todo gênero artístico e literário possuem exigências intrínsecas. Entre narrar um mito, que é uma práxis sagrada, em determinadas circunstâncias, para determinadas pessoas, e compor uma obra de arte, mesmo alicarçada no mito, vai uma distância muito grande.', NULL),
(17, 3, '30', 'Na realidade, a mitologia deixou o século V a.C., meio coxa, \"depurada\" e cambaleante. De saída, teve, no seculo IV a.C., um encontro dramático com o Epicurismo. Epicuro (341-270 a.C.), retomando o atomismo materialista de Demócrito, procurava libertar o homem do temor dos deuses e da necessidade inexorável da Moira. Afinal, se os deuses, distantes e desinteressados do homem, são também matéria, sujeitos, por conseguinte à morte, já que formados, como os homens, por entrechoques atômicos, por que temê-los? O além, grande preocupação do homem grego, não existe. Se tudo é matéria, deuses e alma, o bem supremo está no prazer negativo, na ausência de dor para o corpo e de perturbação para a alma. Deus ou os deuses não agem. De sua Ética, ficou um fragmento sombrio acerca de fragilidade e da impotência divina face ao problema do mal: \"Deus, ou quer impedir os males e não pode, ou pode e não quer, ou não quer nem pode, ou quer e pode. Se quer e não pode, é impotente, o que é impossível em Deus. Se pode e não quer, é invejoso, o que , igualmente, é contrário a Deus. Se nem quer nem pode, é invejoso e impotente: portanto, nem sequer é Deus. Se pode e não quer, o que é a única coisa compatível com Deus, donde provém então a exist6encia dos males? Por que Deus não os impede?\"', NULL),
(18, 3, '36', 'E, como afirma Roland Barthes, o mito não pode, consequentemente, \"ser objeto, um conceito ou uma idéia: ele é um modo de significação, uma forma\". Assim, não se há de definir o mito \"pelo objeto de sua mensagem, mas pelo modo como a profere\".', NULL),
(19, 3, '37', 'Rememorando os mitos, reatualizando-os, renovando-os por meio de certos rituais, o homem torna-se apto a repetir o que os deuses e os heróis fizeram \"nas origens\", porque conhecer os mitos é aprender o segredo da origem das coisas. \"E o rito pelo qual se exprime (o mito) reatualiza aquilo que é ritualizado: re-criação, queda, redenção\".', NULL),
(20, 3, '40', 'Esse sentimento se transforma em instrumento de compreensão, pois torna aquele que o vive capaz de descobrir, como que por intuição, o eterno no transitório, o infinito no finito, o absoluto através do relativo.', NULL),
(21, 4, '18', '(...) mito é narrativa aplicada, narrativa como verbalização dos dados complexos, supra-individuais, colectivamente importantes. Nesse sentido, o mito é fundamental (...) como \"carta de fundação\" de instituições, explicação de rituais, precedente para aforismos mágicos, esboço de reivindicações familiares ou étnicas, e, sobretudo, como orientação que mostra o caminho neste mundo ou no do além. O mito neste sentido nuca existe \"puro\" em si, mas tem por alvo a realidade; o mito é simultaneamente uma metáfora ao nível da narração.', NULL),
(22, 4, '19', 'Mitos são estruturas de sentido.', NULL),
(23, 5, '122', 'Reason tells man to stand above nature and to be the measure of all things. Reason has divorced man from nature.', NULL),
(24, 5, '40', 'The Renaissance taught men the haughty exaltation of their reason. Modern times, with their science and tecnology turned men towards megalomania. The confusion of our epoch results from this overestimation of reason.', NULL),
(25, 6, '83', 'Walter Pater escreveu que toda arte aspira à condição de música. A razão óbvia (falo na condição de leigo, é claro) seria que, em música, forma e substância não podem ser cindidas uma da outra.', NULL),
(26, 6, '85', 'A palavra \"thunder\" exprimia o trovão e o deus; mas tivéssemos perguntado aos homens que chegaram à Inglaterra com Henngist se a palavra exprimia o estrondo no céu ou o deus colérico, não acho que seriam argutos o suficiente para compreender a diferença. (...) Imagino que, quando proferiam ou escutavam a palavra \"thunder\", ao mesmo tempo ouviam o grave estrondo no céu e viam o raio e pensavam no deus. As palavras eram envoltas em mágica; não tinham um significado estanque.', NULL),
(27, 7, '193', 'Na Grécia, o mito fugiu do rito como o demônio da garrafa. O rito está vinculado ao gesto, e os gestos são limitados: que fazer além de queimar, verter, inclinar-se, untar-se, disputar, comer, copular? Mas, se as histórias começam começam a tornar-se independentes e desenvolvem nomes e relações, um dia perceberemos que continuam a viver por conta própria. Únicos no mediterrâneo, os gregos não transmitiam suas histórias através de uma autoridade sacerdotal. Eram histórias erráticas e também por isso se misturavam tão facilmente. Os gregos habituaram-se, como se fosse normal, a ouvir suas histórias contadas com enredos diferentes. E não havia autoridade última à qual referir-se, para saber qual era a versão justa. Homero era o último nome que se podia evocar: mas Homero não contara todas as histórias.', NULL),
(28, 7, '195', 'Os mitos gregos eram histórias transmitidas com variantes. O escritor, fosse ele Píndaro ou Ovídio, o recompunha, cada vez de um modo diferente, omitindo ou acrescentando. Porém, as novas variantes deviam ser raras e pouco visíveis. Cada escritor aumentava e adelgaçava o corpo da história. Assim o mito continuou a respirar na literatura.', NULL),
(29, 7, '21', 'As figuras do mito vivem muitas vidas e muitas mortes, diversamente das personagens de romances, sempre vinculadas a um só gesto. Mas em cada uma dessas vidas e dessas mortes participam todas as outras e elas ressoam. Podemos afirmar ter superado o limiar do mito somente quando identificamos uma imprevista coerência entre elementos incompatíveis. Abandonada em Naxos, Ariadne foi atravessada por uma flecha de Ártemis por ordem de Dionísio, testemunha imóvel; ou seja, Ariadne enforcou-se em Naxos depois de ter sido abandonada por Teseu; ou seja, grávida de Teseu, náufraga em Chipre, ali morreu das dores do parto; ou seja, Ariadne foi alcançada em Naxos por Dionísio com seu cortejo e com ele celebrou núpcias divinas antes de subir ao céu, onde até hoje podemos vê-la entre as constelações setentrionais; ou ainda, Ariadne foi lançada por Dionísio em Naxos e desde então seguiu-o em suas empresas, como amante e soldado: quando Dionísio atacou Perseu na terra de Argos, Ariadne o seguiu, armada, entre as fileiras das loucas bacantes, até que Perseu sacudiu diante dela o rosto mortífero de Medusa e Ariadne foi petrificada. Tornou-se uma pedra no campo. Nenhuma mulher, nenhuma deusa teve tantas mortes como Ariadne. Aquela pedra na Argólida, aquela constelação no céu, aquela enforcada, aquela morta de parto, aquela donzela golpeada no seio: tudo isso é Ariadne.', NULL),
(30, 7, '65', 'A propósito dos Olímpicos, antes de mais nada pode-se dizer que se tratava de deuses novos. Tinham um nome e uma figura. Mas Heródoto nos garante que, \"até ontem\", não se sabia \"onde havia nascido cada um dos deuses, ou se tinham existido eternamente e qual era o seu aspecto\". Para Heródoto, \"ontem\" significava Homero e Hesíodo, que tinham vivido quatro séculos antes, segundo seus cálculos. E são eles que, em sua opinião, \"deram noma aos deuses, distribuindo as honras e as artes e atribuindo-lhes um aspecto\".', NULL),
(31, 7, '66', 'Quando os gregos precisavam recorrer a uma autoridade suprema, não citavam textos sacros mas sim Homero. Na Ilíada, funda-se a Grécia.', NULL),
(32, 8, '147', 'Fenômenos celestiais que não podiam ser previstos eram agourentos no sentido mais pleno da palavra; eram presságios. Cada solução para um problema de prognóstico astronômico significava a eliminação de mais uma fonte de ansiedade política... A capacidade de prever transferia eventos celestiais do domínio do agouro para o domínio do rítmico e do inteligível.', NULL),
(33, 8, '181', 'Claro, a ocorrência dessas visões em todo o mundo habitado não requer uma explicação em termos de difusão racial ou cultural. O problema é, sem dúvida, psicológico daquela profundidade do inconsciente onde, para citar Jung, \"o homem não é mais um indivíduo distinto, mas sua mente se amplia e se incorpora à mente da humanidade - não a mente consciente, mas a mente inconsciente da humanidade, onde somos todos iguais.\" C. G. Jung. \"Analytical Psycology: its theory and practice\". Nova York. Pantheon Books, 1968, p. 46.', NULL),
(34, 8, '19', 'O sonho é uma pequena porta escondida nos recantos mais íntimos e secretos da alma, abrindo-se para dentro dessa noite cósmica que era psique muito antes de existir qualquer consciência do ego, e que permanecerá psique até onde quer que nossa consciência do ego possa se estender. Pois toda consciência do ego está isolada: ela separa e discrimina, conhece apenas pormenores, e vê apenas o que possa estar relacionado com o ego. Sua essência é a limitação, embora alcance a nebulosa mais distante entre as estrelas. Toda consciência separa; mas, nos sonhos, assumimos a aparência daquele homem mais universal, mais verdadeiro e mais eterno, que vive na escuridão da noite primordial. Lá, ele ainda é o todo, e o todo está nele, indistinguível da natureza e desprovido de toda condição de ego. É dessas profundezas que a tudo unificam que surge o sonho, seja infantil, grotesco e imoral. Em sua transparência e veracidade ele se assemelha tanto a uma flor que nos faz enrubescer diante da insinceridade de nossa vidas.', NULL),
(35, 8, '55', 'Ora, o termo hindu para \"ilusão\" maya ? da raiz verbal ma, \"medir, dispersar aos poucos, formar, criar, construir, exibir ou projetar\" ? refere-se ao poder que tanto cria uma ilusão, como a falsa projeção em si. A arte de um mágico, por exemplo, é maya; é também a ilusão que ele cria. A mestria de um estrategista militar, a do comerciante, a do ator e a do ladrão também são maya, (...) Como um princípio cosmogônico, ? e como um principio feminino e também pessoal ? diz-se que maya possui três poderes:<br>1. Um Poder de Ocultamento que esconde ou dissimula o \"real\", a característica intrínseca e essencial; das coisas; de maneira que, como podemos ler num texto sagrada sanscrítico: \"Apesar de estar oculto em todas as coisas, o Eu não brilha.\"<br>2. Um Poder de Projeção, que emite impressões e idéia ilusórias, junto com desejos e aversões associados ? como poderia acontecer se, por exemplo, numa noite uma pessoa confundisse uma corda com uma cobra e se assustasse. Depois que a ignorância (O Poder de Ocultamento) encobriu o real, a imaginação (O Poder de Projeção) desencadeia os fenômenos. Lemos então que \"esse poder de projeção cria todas as aparências, quer seja dos deuses quer do cosmo\".<br>Esses dois primeiros poderes, dissimulando e projetando, podem ser comparados às propriedades de um prisma, pelo qual a luz solar é transformada nas cores do arco-íris. Disponha essas cores num disco, gire-o, e elas serão vistas como a cor branca. Da mesma forma, quando vistos de certa maneira, os próprios fenômenos poderão revelar o que normalmente ocultam; o que demonstra:<br>3. O Poder Revelador de maya, que é a função da arte e da escritura, do ritual e da meditação, qual seja a de tornar tudo conhecido.', NULL),
(36, 8, '61', 'Ao longo do tempo de séculos de pensamento cristão, duas tradições contrárias de interpretação disputam a interpretação desses símbolos. A primeira podemos chamar de histórica ou prosaica, na qual se entende que as imagens se referem a eventos históricos; a segunda, de experiencial, psicológica ou poética, e ela se refere não ao que era, uma vez, mas ao que é, agora e para sempre; não a qualquer segmento de fenomenalidade, presente ou passada (em que A não é não-A), mas ao interior, aos estados experimentados e possíveis e às crises da consciência, à iluminação e à desilusão (em que A é de fato não-A, uma vez que o que está refletido nas imagens é a própria realidade e a verdade interior da pessoa).', NULL),
(37, 9, '12', 'Sem a coerência dos processos irreversíveis de não-equilíbrio, o aparecimento da vida na Terra seria inconcebível.', NULL),
(38, 9, '14', 'Pensamos situar-nos hoje num ponto crucial dessa aventura, num ponto de partida de uma nova racionalidade que não mais identifica ciência e certeza, probabilidade e ignorância.', NULL),
(39, 9, '14', 'Assistimos ao surgimento de uma ciência que não mais se limita situações simplificadas, idealizadas, mas nos põe diante da complexidade do mundo real, uma ciência que permite que se viva a criatividade humana como a expressão singular de um traço fundamental comum a todos os níveis da natureza.', NULL),
(40, 9, '29', 'O ponto de vista apresentado neste livro é diferente. (...) os desenvolvimentos recentes da física e da química do não-equilíbrio mostram que a flecha do tempo pode ser uma fonte de ordem.', 'Progogine discorda de Gell-Mann quando este afirma que \"Na medida em que se deixam as coisas evoluírem ao acaso, pode-se prever que um sistema fechado, caracterizado por alguma ordem inicial, evoluirá para a desordem, que oferece tantas possibilidades a mais.\" (GELL-MANN, 1994, pp.218–220)\r\n\r\nGELL-MANN, M. (1994). The quark and the jaguar. London: Little Brown and Co. '),
...
(43, 12, '17', 'Os padrões que os cientistas observam na natureza estão intimamente relacionados com os padrões das suas mentes, com seus conceitos, pensamentos e valores. Por isso, os resultados científicos que obtêm e as aplicações tecnológicas que investigam estarão condicionados pela estrutura de suas mentes. Embora grande parte de suas pesquisas detalhadas não seja explicitamente dependente dos seus sistemas de valores, a estrutura mais abrangente dentro da qual essas pesquisas são efetuadas nunca será independente de valores.', NULL),
(44, 12, '17', 'Nossa cultura tem favorecido, com firmeza, valores e atitudes yang, ou masculinos, e tem negligenciado seus valores e atitudes complementares yin, ou femininos. Temos favorecido a auto-afirmação em vez da integração, a análise em vez da síntese, o conhecimento racional em vez da sabedoria intuitiva, a ciência em vez da religião, a competição em vez da cooperação, a expansão em vez da conservação, e assim por diante(...)', NULL),
(45, 12, '25', 'A mente foi separada do corpo, recebendo a inútil tarefa de controlá-lo, causando assim um conflito aparente entre a vontade consciente e os instintos involuntários. Posteriormente, cada indivíduo foi dividido num grande número de compartimentos isolados de acordo com as atividades que exerce, seu talento, seus sentimentos, suas crenças, etc, todos estes engajados em conflitos intermináveis, geradores de constante confusão metafísica e frustração.<br>Esta fragmentação interna espelha nossa visão do mundo \'exterior\', que é encarado como sendo constituído de uma imensa quantidade de objetos e fatos isolados.<br>A crença de que todos estes fragmentos - em nós mesmos, em nosso ambiente e em nossa sociedade - são efetivamente isolados pode ser encarada como a razão essencial para a atual série de crises sociais, ecológicas e culturais.', NULL),
(46, 13, '17', 'A idéia de que o nome e a essência se correspondem em uma relação intimamente necessária, que o nome não só designa, mas também é este mesmo ser, e que contém em si a força do ser, são algumas das suposições fundamentais dessa concepção mítica (...).', NULL),
(47, 13, '', 'O mito não é, para ele (Max Müler), nem a transformação da história em lenda fabulosa, nem uma fábula aceita como histórica; e, tampouco, surge diretamente da contemplação das grandes configurações e poderes da natureza. Tudo a que chamamos de mito é, segundo seu parecer, algo condicionado e mediado pela atividade da linguagem: é, na verdade, o resultado de uma deficiência lingüística originária, de uma debilidade inerente à linguagem. Toda designação lingüística é essencialmente ambígua e, nesta ambigüidade, nesta \'paronímia\' das palavras, está a fonte primeva de todos os mitos.', 'Cassirer cita Max Müller'),
(48, 13, '19', '\"A mitologia é inevitável, é uma necessidade inerente à linguagem, se reconhecemos nesta a forma externa do pensamento: a mitologia é, em suma, a obscura sombra que a linguagem projeta sobre o pensamento, e que não desaparecerá enquanto a linguagem e o pensamento não se superpuserem completamente : o que nunca será o caso. Indubitavelmente, a mitologia irrompe com maior força nos tempos mais antigos da historia do pensamento humano, mas nunca desaparece por inteiro. Sem dúvida, temos hoje nossa mitologia, tal como nos tempos de Homero, com a diferença apenas de que atualmente não reparamos nela, porque vivemos à sua própria sombra e porque, nós todos, retrocedemos ante a luz meridiana da verdade. Mitologia, no mais elevado sentido da palavra, significa o poder que a linguagem exerce sobre o pensamento, e isto em todas as esferas possíveis da atividade espiritual\".', NULL),
(49, 13, '68', 'A identidade essencial entre a palavra e o que ela designa torna-se ainda mais evidente se, em lugar de considerar tal conexão do ponto de vista objetivo, a tomarmos de um angulo subjetivo. Pois também o eu do homem, sua mesmidade e personalidade, estão indissoluvelmente unidos com seu nome, para o pensamento mítico. O nome não é nunca um mero símbolo, sendo parte da personalidade de seu portador; é uma propriedade que deve ser resguardada com o maior cuidado e cujo uso exclusivo deve ser ciosamente reservado.', NULL),
(50, 14, '142', 'Cada ser humano vive dentro de um certo modelo cultural e interpreta a experiência com base no mundo de formas assuntivas que adquiriu: a estabilidade deste mundo é essencial para que possa mover-se razoavelmente em meio às provocações contínuas do ambiente e organizar as propostas constituídas pelos eventos externos em um conjunto de experiências orgânicas. Manter portanto nosso conjunto de assunções sem submetê-lo a mutações indiscriminadas é uma das condições de nossa existência de seres racionais. (...) Outra condição de nossa sobrevivência enquanto seres pensantes é justamente a de saber fazer evoluir nossa inteligência e nossa sensibilidade, de modo que cada experiência adquirida enriqueça e modifique o sistema de nossas assunções. O mundo de formas assuntivas deve manter-se orgânico no sentido de que deve crescer harmoniosamente, sem saltos e sem deformações, mas deve crescer, e crescendo, modificar- se. Em última análise, é esta a diferença que torna tão dinâmico e progressivo o modelo cultural do homem ocidental comparado com o de certos povos primitivos. Os povos primitivos são tais, não porque o modelo cultural originariamente elaborado fosse bárbaro e inaproveitável (pois, pelo contrário, adaptava-se à situação para a qual havia sido imaginado), mas por não ter esse modelo sabido evoluir; acomodando-se estaticamente nele, os representantes dessa cultural não foram mais capazes de interpretá-la em todas as suas possibilidades originais e continuaram aceifando as assunções originárias como fórmulas ocas, elementos de ritual, tabus invioláveis. (...) Temos poucos motivos para reputar universalmente superior o modelo cultural ocidental moderno, mas um deles é justamente sua plasticidade, sua capacidade de responder aos desafios das circunstâncias pela elaboração contínua de novos módulos de adaptação e novas justificações da experiência.', NULL),
(51, 14, '205', 'A descontinuidade é, tanto nas ciências quanto nas relações comuns, a categoria de nosso tempo: a cultura ocidental moderna destruiu definitivamente os conceitos clássicos de continuidade, de lei universal, de relação causal, de previsibilidade dos fenômenos: em suma, renunciou à elaboração de fórmulas gerais que pretendem definir o conjunto do mundo em termos simples e definitivos. Novas categorias ingressam na linguagem contemporânea: ambigüidade, insegurança, possibilidade, probabilidade. É extremamente perigoso mostrar as coisas e assimilar,  como estamos fazendo, idéias provenientes dos mais diversos setores da cultura contemporânea com suas acepções precisas e distintas, mas o próprio fato de um discurso como este ser vagamente possível e de alguém poder indulgentemente aceitá-lo como correto, significa que todos esses elementos da cultura contemporânea estão unificados por um estado de espírito fundamental: a consciência de que o universo ordenado e imutável de outrora, no mundo contemporâneo, representa, quando muito uma nostalgia: mas já não é nosso. Daqui -- e será preciso dizê-lo? -- nasce a problemática da crise, pois é preciso uma firme estrutura moral e muita fé nas possibilidades do homem para aceitar despreocupadamente um mundo no qual parece impossível introduzir módulos de ordem definitivos.', NULL),
(52, 15, '', 'A mais importante diferença entre o homem das sociedades arcaicas e tradicionais, e o homem das sociedades modernas, com sua forte marca de judeu-cristianismo, encontra-se no fato de o primeiro sentir-se indissoluvelmente vinculado ao Cosmo e os ritmos cósmicos, enquanto que o segundo insiste em vincular-se apenas a História.', ''),
(53, 15, '12', 'Os mitos preservam e transmitem os paradigmas, os modelos exemplares, para todas as atividades responsáveis a que o homem se dedica. (...) para o homem das sociedades arcaicas e tradicionais, os modelos para suas instituições e as normas para suas várias categorias de comportamento teriam sido \"revelados\" no começo dos tempos, (...) consequentemente, eles seriam vistos como tendo origem sobre-humana e \"transcedental\".', NULL),
(54, 15, '18', 'Se observarmos o comportamento generalizado do homem arcaico, nós nos veremos diante do seguinte fato: nem os objetos do mundo externo, nem os atos humanos, falando de maneira apropriada, têm qualquer valor autônomo intrínseco. Os objetos ou atos adquirem um valor, e, ao fazer isso, tornam-se reais, porque participam, de uma forma ou outra, de uma realidade que os transcende. Entre tantas pedras, uma torna-se sagrada - e, assim, instantaneamente, satura-se do ser (...). O objeto surge como receptáculo de uma força exterior que o diferencia de seu próprio meio, e lhe dá significado e valor.', NULL),
(55, 15, '19', 'Rituais e gestos profanos (...) adquirem o significado que lhes é atribuído, (...) materializam esse significado, porque repetem de maneira deliberada estes ou aqueles atos praticados ab origine por deuses, heróis ou ancestrais.', NULL),
(56, 15, '38', '(Nas culturas tradicionais ocorre) a abolição do tempo, por meio da imitação de arquétipos e da repetição de gestos paradigmáticos. Um sacrifício, por exemplo, não só reproduz com exatidão o sacrifício original, revelado por um Deus ab origine, no princípio dos tempos, mas também é realizado naquele mesmo momento mítico primordial; em outras palavras, cada sacrifício realizado repete o sacrifício inicial e coincide com ele.', NULL),
(57, 16, '121', 'Durante milênios, o homem trabalhou ritualmente  e pensou miticamente nas analogias entre o macrocosmo e o microcosmo. (...) Desde a Renascença, (...) essa dimensão cósmica que o homem acrescentava ritualmente à sua existência nos é negada.', NULL),
(58, 16, '17', 'Para o homem das sociedades arcaicas, (...) o essencial é conhecer os mitos. Essencial não somente porque os mitos lhe oferecem um a explicação do Mundo, e de seu próprio modo de existir no Mundo, mas sobretudo porque, ao rememorar os mitos e reatualizá-los, ele é capaz de repetir o que os Deuses, os Heróis ou os Ancestrais fizeram ab origine. Conhecer os mitos é aprender o segredo da origem das coisas.', NULL),
(59, 16, '23', 'O mito, quando estudado ao vivo, não é uma explicação científica, mas uma narrativa que faz reviver uma realidade primeva, que satisfaz profundas necessidades religiosas, aspirações morais, a pressões e a imperativos de ordem social, e mesmo a exigências práticas.', NULL),
(60, 16, '68', 'Ele precisava reduzir a nada as ruínas e os escombros acumulados pelas revoluções plásticas precedentes; precisava chegar a uma modalidade germinal da matéria, a fim de poder recomeçar  a história da arte a partir do zero.', NULL),
(61, 16, '8', 'fornece os modelos para conduta humana, conferindo, por isso mesmo, significação e valor à existência.', NULL),
(62, 17, '21', 'O ocidental moderno experimenta um certo mal-estar diante das inúmeras formas de manifestação do sagrado: é-lhe difícil aceitar que, para certos seres humanos, o sagrado possa manifestar-se em pedras um em árvores, por exemplo. Mas, (...) não se trata da veneração da pedra como pedra, de um culto da árvore como árvore. A pedra sagrada, a árvore sagrada, não são adoradas como pedra ou árvore, são-no justamente porque são hierofanias, porque \'mostram\' qualquer coisa que já não é pedra nem árvore, mas o sagrado, o \'ganz andere\'.<br>Nunca será demais insistir no paradoxo que toda hierofania constitui, até a mais elementar. Manifestando o sagrado, um objeto qualquer torna-se outra coisa, e contudo, continua a ser ele mesmo, porque continua a participar do seu meio cósmico envolvente. Uma pedra sagrada nem por isso é menos uma pedra; aparentemente (com maior precisão: do ponto de vista profano) nada a distingue de todas as demais pedras. Para aqueles a cujos olhos uma pedra se revela sagrada, a sua realidade imediata transmuda-se numa realidade sobrenatural. Por outros termos, para aqueles que têm uma experiencia religiosa, toda a Natureza é susceptível de revelar-se como sacralidade cósmica. O Cosmos na sua totalidade po transformar-se numa hierofania.', NULL),
(63, 17, '21', 'O homem das sociedades arcaicas tem a tendencia para viver o mais possível em o sagrado ou muito perto dos objetos consagrados. Esta tendência é de resto compreensível, porque para os \'primitivos\' como para o homem de todas as sociedades pré-modernas, o sagrado equivale ao poder, e, no fim de contas, à realidade por excelência. O sagrado está saturado de ser. (...) A oposição sagrado- profano traduz-se muitas vezes como uma oposição entre real e irreal ou pseudo- real.', NULL),
(64, 17, '22', 'Medir-se-á o precipício que separa as duas modalidades de existência * sagrada e profana * lendo as descrições concernentes ao espaço sagrado e à construção ritual da moradia humana, ou às variedades da experiência religiosa do Tempo, ou às relações do homem religioso com a Natureza e o mundo dos utensílios, ou à consagração da própria vida humana, à sacralidade de que podem ser carregadas as suas funções vitais (alimentação, sexualidade, trabalho, etc). Bastará lembrar no que setornaram, para o homem moderno e a- religioso, a cidade ou a casa, a Natureza, os utensílios ou o trabalho, para captar tudo o que o distingue de um homem pertencente às sociedades arcaicas ou mesmo de um camponês da Europa cristã.', NULL),
(65, 17, '22', 'Digamos imediatamente que o mundo profano na sua totalidade, o Cosmos totalmente des- sacralizado, é uma descoberta recente na história do espírito humano. (...) o homem moderno des- sacralizou o seu mundo e assumiu uma existência profana. (...) [o homem moderno] sente uma dificuldade cada vez maior em reencontrar as dimensões existenciais do homem religioso das sociedades arcaicas.', NULL),
(66, 17, '23', 'Para a consciência moderna, um ato fisiológico * a alimentação, a sexualidade, etc * não é, em suma, mais do que um fenômeno orgânico (...) Mas para o \'primitivo\', um tal ato nunca é simplesmente fisiológico; é, ou pode tornar-se, um \'sacramento\', quer dizer, uma comunhão com o sagrado.', NULL),
(67, 17, '23', '(...) o sagrado e o profano constituem duas modalidades de ser no mundo, duas situações existenciais assumidas pelo homem ao longo da sua história.', NULL),
...
(98, 20, '27', 'Tal é, o seu conjunto, a mitologia grega: matéria com origens bastante diversas, fragmentos muitas vezes mal reunidos em sínteses factícias, em que o trabalho lento dos sábios, dos escritores e dos poetas acrescentou ou eliminou, segundo a sua disposição de momento, mas em que ainda se distinguem, por vezes, os dados primitivos da imaginação e da piedade populares.', NULL),
...
(101, 22, '91', 'a hipermídia bem sucedida depende da roteirização que determina o índice de receptividade, da primeira telas às sucessivas, propiciando ao usuário a segurança de quem tem o controle de sua jornada.', NULL),
...
(105, 25, '89', 'Desde sempre o iluminismo, no sentido mais abrangente de um pensar que faz progressos, perseguiu o objetivo de livrar os homens do medo e de fazer deles senhores. Mas, completamente iluminada, a terra resplandece sob o signo do infortúnio triunfal. O programa do iluminismo era o de livrar o mundo do feitiço. Sua pretensão, a de dissolver os mitos e anular a imaginação por meio do saber.', NULL),
(106, 25, '90', 'O que os homens querem aprender da natureza é como aplicá-la para dominar completamente sobre ela e sobre os homens. Fora disso, nada conta. Sem escrúpulos para consigo mesmo, o iluminismo incinerou os últimos restos de sua própria consciência de si. Só um pensar que faz violência a si próprio é suficientemente duro para quebrar os mitos. (...) Caminhando em busca da ciência moderna, os homens se despojam do sentido.', NULL),
(107, 25, '91', 'A partir de agora, a matéria deverá finalmente ser dominada, sem apelo a forças ilusórias que a governem, ou que nela habitem, sem apelo a  propriedades ocultas. O que não se ajusta às medidas da calculabilidade e da utilidade é suspeito para o iluminismo.', NULL),
(108, 25, '93', 'O preço que os homens pagam pela multiplicação de seu poder é a sua alienação daquilo sobre o que exercem o poder.', NULL),
(109, 25, '94', '(...) a natureza desqualificada torna-se o material caótico de uma simples classificação e o si-mesmo todo-poderoso converte-se em mero ter, em entidade abstrata. Na magia há representantes específicos. O que ocorre com a lança do inimigo, com o seu cabelo, com o seu nome, atinge, ao mesmo tempo, a pessoa, e o animal de sacrifício é massacrado em lugar do deus. A substituição do sacrifício marca um passo em direção da lógica discursiva.<br>O mundo da magia ainda continha diferenças, cujos traços desapareceram, até mesmo da forma da linguagem. <br><br>As múltiplas afinidades entre entes são reprimidas por um a única relação entre o sujeito doador de sentido e o objeto sem sentido, entre a significação racional e o suporte causal da significação (...) Na etapa da magia, sonho e imagem não valiam como meros signos da coisa, mas como vinculados a ela por semelhança ou pelo nome. (...) A feitiçaria, como a ciência, tem seus fins, mas ela os persegue pela mimes e não por um distanciamento progressivo do objeto.', NULL),
(110, 25, '98', 'O homem tem a ilusão de se ter libertado do medo quando já não há mais nada de desconhecido. Isso determina a via da desmitologização do iluminismo, que identifica o animado com o inanimado, assim como o mito identificava o inanimado com o animado.', NULL),
(111, 25, '98', 'As representações dos mitos podem ser reduzidas, sem deixar resto, a relações com a natureza.', NULL),
(112, 25, '99', 'A doutrina dos sacerdotes era simbólica, no sentido em que nela coincidiam signo e imagem. Como testemunham os hieróglifos, a palavra desempenhava originariamente também a função de imagem. Essa função passou para os mitos. Tanto os mitos quanto os ritos mágicos visam à natureza que se repete. Ela é a essência do simbólico: um ser ou um processo que é representado como eterno, por dever sempre converter-se novamente em acontecimento, no perfazer-se do símbolo. Inesgotabilidade, renovação sem fim, permanência do significado, não são apenas atributos de todos os símbolos mas seu verdadeiro teor.', NULL),
(113, 25, '99', 'Como signo, a palavra entra na ciência; como som, como imagem, como palavra propriamente dita, ela é distribuída pelas diferentes artes; sem que jamais possa ser restabelecida pela soma dessas últimas, pela sinestesia ou pela \'arte global\'. Como signo, a linguagem deve resignar-se a ser um cálculo, para conhecer a natureza, precisa renunciar à pretensão de lhe ser semelhante.', NULL),
(114, 25, '99', 'A ciência, na sua interpretação neopositivista, torna-se esteticismo, um sistema de signos soltos, destituídos de qualquer intenção que transcenda o sistema (...)', NULL),
(115, 25, '100', 'A natureza não deve mais ser influenciada por assemelhação, mas dominada pelo trabalho.', NULL),
(116, 25, '100', 'a aparição do todo no particular.', NULL),
(117, 25, '103', 'O iluminismo devorou finalmente não só os símbolos, mas também seus sucessores; os conceitos universais, e da metafísica não restou nada mais do que aquela angústia abstrata perante o coletivo, da qual se originou.', NULL),
(118, 25, '103', 'Na religião judaica, (...) o vínculo entre nome e ser ainda é reconhecido na proibição de pronunciar o nome de Deus.', NULL),
...
(121, 27, '94', 'O homem moderno não entende o quanto o seu \'racionalismo\' (que lhe destruiu a capacidade de reagir a idéias e símbolos numinosos) o deixou à mercê do \'submundo\' psiquico. Libertou-se das \'superstições\' (ou pelo menos pensa tê-lo feito), mas neste processo perdeu seus valores espirituais em escala positivamente alarmante. Suas tradições morais e espirituais desintegraram-se e, por isso, paga agora um alto preço em termos de desorientação e dissociação universais.', NULL),
(122, 27, '95', 'À medida que aumenta o conhecimento científico diminui o grau de humanização do nosso mundo. O homem sente-se isolado no cosmos porque, já não estando envolvido com a natureza, perdeu a sua \'identificação emocional inconsciente\' com os fenômenos naturais. E os fenômenos naturais, por sua vez, perderam aos poucos as suas implicações simbólicas. O trovão já não é a voz de um deus irado, nem o raio o seu projétil vingador. Nenhum rio abriga mais um espírito, nenhuma árvore é o princípio de vida do homem, serpente alguma encarna a sabedoria e nenhuma caverna é habitada por demônios. Pedras, plantas e animais já não têm vozes para falar ao homem e o homem não se dirige mais a eles na presunção de que possam entendê-lo.', NULL),
...
(126, 29, '9', 'A crise de que Husserl falava lhe parecia tão profunda que ele se perguntava se a Europa ainda era capaz de sobreviver a ela. As raízes da crise ele acreditava ver no início dos Tempos Modernos, em Galileu e em Descartes, no caráter unilateral das ciências europeias que tinham reduzido o mundo a um simples objeto de exploração técnica e matemática, e tinham excluído de seu horizonte o mundo concreto da vida, \"die Lebenswelt\", como ele dizia. O crescimento das ciências impulsionou o homem nos túneis das disciplinas especializadas. Quanto mais avançava em seu saber, mais perdia de vista o conjunto do mundo e ele mesmo, soçobrando assim no que Heidegger, discípulo de Husserl, chamava, em uma fórmula bela e quase mágica, \'o esquecimento do ser\'.', NULL),
(127, 29, '15', 'Kafka e Hasek nos põem em confronto com este imenso paradoxo: durante a época dos Tempos Modernos, a razão cartesiana corroía, um após o outro, todos os valores herdados da Idade Média. Mas, no momento da vitória total da razão, é o irracional puro (a força querendo apenas seu querer) que se apossará do cenário do mundo, porque não haverá mais nenhum sistema de valores comumente admitido que possa lhe fazer obstáculo.', NULL),
(128, 29, '22', 'A vanguarda viu as coisas de outro modo; estava possuída pela ambição de estar em harmonia com o futuro. Os artistas de vanguarda criaram obras realmente corajosas, difíceis, provocadoras, vaiadas, mas as criaram com a certeza de que \'o espírito de tempo\' estava com eles e que, amanhã ele lhes daria razão.<br><br>(...) o namoro com o futuro é o pior dos conformismos, a covarde adulação do mais forte. Pois o futuro é sempre mais forte que o presente.', NULL),
(129, 29, '58', 'É preciso ler atentamente, devagar, Os Sonâmbulos, (...) seus personagens não são capazes de enfrentar a realidade como coisa concreta. Diante de seus olhos tudo se move como símbolos (...) e é aos símbolos que eles reagem quando pensam agir sobre a realidade.', NULL),
...
(133, 31, '31', 'a sua finalidade é atingir, pelos meios mais diminutos e econômicos, uma compreensão geral do universo e não só uma compreensão geral, mas sim total. Isto é, trata-se de um modo de pensar que parte do princípio de que, se não se compreende tudo não se pode explicar coisa alguma. Isto está inteiramente em contradição com o modo de proceder do pensamento científico, que consiste em avaçar etapa por etapa, tentando dar explicações para um determinado número de fenômenos e progredir, em seguida, para outros tipos de fenômenos, e assim por diante. Como já disse Descartes, o pensamento científico divide a dificuldade em tantas partes quantas necessárias para a resolver.', 'sobre o modo de pensamento dos povos primitivos'),
(134, 31, '34', 'Actualmente, o desafio reside naquilo que podemos chamar a supercomunicação * ou seja, a tendência para saber exactamente, num determinado ponto do mundo, o que se passa nas restantes partes do globo. (...) é somente em condições de subcomunicação que ela [a cultura] pode produzir algo. Hoje em dia estamos ameaçados pela perspectiva de sermos apenas consumidores, indivíduos capazes de consumir seja o que for que venha de qualquer ponto do mundo e de qualquer cultura, mas desprovidos de qualquer originalidade.', NULL),
(135, 33, 'h6', 'Assim, na tradição cabalística, ao lado da \"árvore do conhecimento\", há uma \"árvore da vida\". É a cisão entre estas duas árvores que, de acordo com G. Scholem, permite ao Mal irromper no mundo. De maneira metafórica, podemos dizer que aí se acha, de certo, uma das fontes da separação feita entre a filosofia e a arte, seu antagonismo profundo e a dificuldade, no que respeita a primeira, de integrar a experiência desta última. Bem cedo, portanto, presenciamos o irrompimento entre uma cultura \"filosófico - racionalista\" e uma outra \"pópulo - mitológica\" - que, tal qual um fio vermelho, se encontra com regularidade no longo percurso da humanidade.', NULL),
(136, 33, 'h6', 'Trata-se de um antigo paradoxo, ainda hoje existente, entre o que quer explicar (desdobrar, pôr na horizontal) e dirigir a vida, e esta mesma vida, que se esquiva sempre à explicação. A primeira sensibilidade procede por distinção e por subsequente análise; a segunda prefere a conjunção e a apreensão global dos diversos elementos do dado mundano.', NULL),
...
(138, 35, '274', 'As \'culturas folclóricas\' pertencem a unidades sociais pequenas, altamente integradas ou a agregados destas unidades que já alcançavam ajustamento recíproco satisfatório. Nessas culturas os ítens novos não aparecem com freqüência e a sociedade tem muito tempo para submetê-los a testes e para assimilá-los aos padrões preexistentes. Em tais culturas o núcleo quase que constitui o todo.', NULL),
(139, 35, '274', 'Graças à organização de pesquisas e à invenção, novos ítens estão ap[arecendo com tal freqüência que a sociedade norte-americana não tem tido tempo para submetê-los a testes suficintes, menos ainda para pô-los em formas facilmente assimiláveis. Vários desses novos ítens são de natureza a exigir mudanças radicais em outros setores da cultura. Assim, a mecanização da agricultura ou a aceitação da evolução orgânica como fato estabelecido acarretam uma série de modificações compensatórias em outros aspectos da vida e do pensamento nos Estados Unidos, o que só se alcançará depois de anos. Nas civilizações modernas, portanto, o núcle da cultura está sendo progressivamente reduzido. A civilização norte-americana, tal como se apresenta ao indivíduo é, principalmente, uma variedade de alternativas entre pode, ou, frequentemente, tem de escolher. Rapidamente se aproxima o ponto em que o número de ítens a respeito dos quais todos os membros da sociedade concordem já não será suficiente para fornecer forma e padrão à cultura.', NULL),
(140, 35, '332', '(...) desde que toda cultura é uma configuração cujas partes se ajustam reciprocamente umas às outras, a introdução de qualquer novo elemento cultural imediatamente perturba o equilíbrio.', NULL),
...
(155, 41, '17', 'No século VI a. C. um siciliano de nome Evêmero escreveu uma História Sagrada, onde descreve uma visita a uma ilha imagináriachamada Panchaea, em algum ponto do Ocenao Ïndico. Ali ele soube - através de uma inscrição na parte interna do Templo de Zeus - que Zeus nasceu na Crete, vijou pelo Oriente, e foi proclamado deus antes de voltar para a sua terra, onde morreu.', NULL),
(156, 41, '156', 'Evêmero estaria sendo satírico - à custa das experiências de Alexandre Magno na Índia - e recomendava cinicamente a autodeificação como um meio para fins políticos?', 'Como Evêmero poderia saber das experiências de Alexandre Magno se este nasceu 3 séculos depois de Evêmero? '),
(157, 41, '18', 'Os deuses eram benfeitores cujas dádivas tinham tornado possível a civilização, na opinião de Prodicus de Ceos (sec. V a. C.), que observou a ssociação do pão com Demeter, e do vinho com Dionísio, (...)', NULL),
(158, 41, '19', 'Ainda mais tarde, e de modo igualmente discutível, o evemerismo motivaria a teoria de Herbert Spencer: \"a adoração dos antepassados é a motivação de todas as religiões\" (The Principles of Sociology - Londres, 1882 - i 440)', NULL),
(159, 41, '19', 'O evemerismo incorporou o que Fontenrose denomina \"palaifatismo\", de Palaifatus, que tentou - em De Incredibilibus (sec. IV a. C.) - trasnformar eventos míticos em acontecimentos possíveis, e espalhou a conhecida história segunda a qual Acteão não foi devorado pelos cães de caça, mas pelas dívidas contraídas em conseqüencia de caçadas extravagantes.', NULL),
(160, 41, '20', 'À medida que a cronologia da antigüidade ia se tornado mais refinada, faziam-se esforços cada vez mais fantásticos para vincular datas exatas com os episódios preservados nos mitos, às vezes mediante evidências internas, como por exemplo a referência a um evento astronômico localizável no tempo: a ocorrência de um cometa ou de um eclipse. (...) Os evemeristas que acreditavam que Ceres tinha sido deificada por ter ensinado o cultivo de cereais aos gregos agradecidos, inteiravam-se agora de que este evento tinha acontecido em 1030 a. C. Perseu salvou Andrômeda no ano de 1005; Teseu matou o Minotauro em 968; Hélia afogou-se no Helesponto (\"que recebeu o seu nome\") em 962; Prometeu foi libertado em 937.', NULL),
...
(183, 43, '64', 'A ciência moderna escolhe e isola parercelas de realidade e realiza suas experiâncias só quando criou certas condições favoráveis à observação. De certo modo, a ciência inventa a realidade sobre a qual opera.', NULL),
(184, 43, '64', 'A revolução de Copérnico mostrou que o homem não era o centro do universo nem o rei da criação. O homem ficou só e destronado, mas apto a refazer a sua morada terrestre. Como se sabe, a primeira conseqüência desta atitude foi o desaparecimento de noções que eram a justificação da vida e o fundamento da história. Refiro-me a esse complexo sistema de crenças que, para simplificar, conhece-se como sagrado, o divino ou o trascendente.', NULL),
...
(189, 35, '275', 'Rapidamente se aproxima o ponto em que o número de ítens a respeito dos quais todos os membros da sociedade já não serão suficientes para fornecer forma e padrão à cultura.', NULL),
(190, 35, '300', 'Há muitos exemplos de trabalhadores nativos que cobram mais, proporcionalmente, por três ou quatro objetos idênticos, por exemplo, cadeiras para formar um conjunto, do que por um objeto só, simplesmente porque não gostam de repetição', NULL),
...
(192, 7, '196', 'A saída da opacidade profana, a intensificação da vida ruma a qualquer direção, honra ou morte, vitória ou sacrifício, núpcias ou súplica, iniciação ou possessão, purificação ou luto, ruma a tudo o que se agita e exige um significado, era assinalada para os gregos pela apariação de faixas ondulantes de lã; geralmente brancas ou vermelhas, amarradas na cabeça, nos braços, num ramo, numa proa, numa estátua, num machado, numa pedra numa trípode. O olho moderno se depara co melas por todas parte, nos fragmentos que sobreviveram, e não as vê, descarta-as do centro das atenções como detalhes decorativos e insiginificantes. Para o olho grego valia o oposto: eram aquela faixas, leves e imóveis, que provocavam o significado, servindo para delimitá-lo e celebrá-lo. Tudo aquilo que acontece na macia moldura das faixas era diferente e separado do resto. O que anunciavam aquelas faixas, aquelas fitas? Algo a mais, um rastro flutuante que se agregava a um ser ou aquela coisa.', NULL),
(193, 7, '204', 'Na variada multiplicidade de suas formas, o sacrifício se resume a dois únicos gestos: expulsão (purificação) e assimilação (comunhão). Estes dois gestos compartilham somente o elemento da destruição: matar, devorar ou abandonar a uma morte segura o ser expulso. Existem mortes para comer, assimilar; e existem mortes para separar, afastar. Para tudo o mais, os dois gestos divergem.<br><br>Na forma extrema da expulsão, a vítima é lapidada, porque os que sacrificam não se expõem ao risco do contato; na forma extrema da assimilação, a carne da vítima é devorada ainda palpitante. Seria uma convenção errada, um equívoco antigo, serem estes dois gestos definidos como sacrifício? Poderia parecer, até nos darmos conta de que logo convergem, assim que atrás deles se delineia uma outra figura: a hierogamia. A hierogamia é o prossuposto do sacrifício, mas por parte dos deuses. É a primeira mistura entre dois mundos, divino e humano, à qual o sacrifício tenta responder. Com uma resposta somente humana, de criaturas que vivem no irreversível e não podem assimilar (ou deixar de assimilar) sem matar. Ao que fora o envolvimento erótico do corpo responde ora a faca que esquarteja ora a mão que joga a pedra.<br><br>Com o tempo, homens e deuses encontraram uma língua franca, que se compunha de hierogamia e sacrifício. As variações do seu cindir-se, opor-se e misturar-se foram tantas quantas as frases daquela língua. E quando esta língua foi declarada morta, começou a se falar de mitologia.', NULL),
(194, 46, '226', 'Um mundo cada vez mais complexo não pode ser mais dominado pelo designer individualmente. A teoria dos sistemas foi reconhecida como disciplina importante e que poderia ser útil para o design. Ela ganha hoje uma nova atualidade, quando se procura, baseado nos pensamentos de Niklas Luhmann, se pensar o design sistematicamente, quer dizer de forma integral e em rede.', NULL),
(195, 46, '251', 'Christopher Alexander, um dos pais da metodologia do design, enumerou quatro argumentos para se armar o processo de projeto com uma metodologia própria:<br><br>- os problemas de projeto se tornaram por demais complexos.<br>- a quantidade de informações necessárias para a resolução de problemas de projeto elevou-se de tal forma que o designer por si só não as consegue coletar nem manipular.<br>- a quantidade de problemas de projeto aumentou rapidamente.<br>- a espécie de problemas de projeto, comparada a épocas anteriores, vem se modificando em ritmo acelerado, de forma que se torna cada vez mais raro poder se valer de experiências anteriores.', NULL),
(196, 48, '20', 'O que é complexidade? À primeira vista, a complexidade é um tecido (complexus: o que é tecido em conjunto) de constituintes heterogêneos inseparavelmente associados: coloca o paradoxo do uno e do múltiplo. Na segunda abordagem, a complexidade é efetivamente o tecido de acontecimentos, ações, interações, retroações, determinações, acasos, que constituem o nosso mundo fenomenal.', NULL),
(197, 51, '164', '(...) é possível entender o método científico ou projetual como receita, como uma série de prescrições, enfim como O Método, calcado no modelo das ciências naturais. Mas também é possível entendê-lo como caminho único a ser traçado por cada pesquisa, cabendo ao pesquisador a sua construção e validação. Nessa perspectiva, em cada projeto ou pesquisa é a reinvenção do método, a metodologia é entendida como uma linguagem, um repertório a partir do qual cada investigador molda os elementos necessários à construção de seu texto particular. O ensino do método seria, desde então, comparável à transmissão de uma linguagem, de um caldo cultural.', NULL),
...
(200, 55, '368', 'Alguns dos personagens são replicantes, seres artificiais em forma humana. Harvey diz que os replicantes são simulacros, não meras imitações mas ´reproduções totalmente autênticas\', indistinguíveis em todos os aspectos dos seres humanos.', 'Harvey, D. Condição pós-moderna. São Pauylo: Loyola. 1996. '),
...
(205, 46, '256', 'Para a metodologia, o trabalho de Paul Feyerabend (1976) foi particularmente decisivo. Ele se opôs ao pensamento de que um método determinado (p. ex. o cartesiano) deveria ser aceito de forma geral: \"Uma única opinião pode ser útil para uma religião, para uma vida tímida e ávida de um (novo ou velho) mito ou para os fracos e subjugados por um tirano\". Para o conhecimento objetivo são necessárias muitas idéias. Para isso, é necessário um método que privilegie a variedade como único compatível com uma concepção humanística. <br>No design, esta concepção só ganhou significado nos anos 80, quando por meio dos pós-modernos novas tendências de design foram propagadas. Neste momento, uma mudança de paradigmas na metodologia de design também ficou evidente: até os anos 70 os métodos empregados eram orientados na sua maioria dedutivamente, isto é, era desenvolvida para um problema geral uma solução especial (de fora para dentro). No novo design, trabalha-se de forma mais indutiva, isto significa se perguntar para quem (para que grupo específico) um projeto especial deva ser colocado no mercado (de dentro para fora).', NULL),
...
(210, 60, '46', 'O influente artigo de Douglas Lee \'Requiem for large-scale planning models\' , apareceu num número de 1973 na Jouranl of the American Institute of Planners e previu corretamente a queda do que considerava os fúteis esforços dos anos 60 para desenvolver modelos de planejamento de larga escala, abrangentes e integrados (muitos deles especificados com todo rigor que a criação de modelos matemáticos computadorizados podia então permitir) para regiões metropolitanas. Pouco depois o New york Times descreveu como \'dominantes\' os planejadores radicais (inspirados por Jane Jacobs) que tinham feito um ataque tão violento aos pecados sem alma do planejamento urbano modernista nos anos 60. Hoje em dia é norma procurar estratégias \'pluralistas\' e \'orgânicas\' para a abordagem do desenvolvimento urbano como uma colagem de espaços e misturas altamente diferenciados, em vez de perseguir planos grandiosos baseados no zoneamento funcional de atividades diferentes.', NULL),
(211, 60, '49', 'Os planejadores \'modernistas\' de cidades, tendem, de fato, a buscar o \'domínio\' da metrópole como \'totalidade\' ao projetar deliberadamente uma \'forma fechada\', enquanto os pós-modernistas costumam ver o processo urbano como algo incontrolável e \'caótico\', no qual a \'anarquia\' e o \'acaso\' pode \'jogar\' em situações inteiramente \'abertas\'.', NULL),
(212, 61, '560', 'O desafio da complexidade vem então do fato que cada um desses princípios tenha se visto abalado, e mesmo questionado, no decorrer de diversos desenvolvimentos científicos durante o século XX (...)<br>(...) desde meados do século XX a termodinâmica começou a contribuir com algo escandaloso à ordem perfeita da física clássica, porque ela não somente levava uma idéia de irreversibilidade com relação às equações reversíveis desta física, mas também de degradação nessa ordem maravilhosa (...).<br>Este princípio deu muito o que falar na época. Muitos se perguntaram se o mundo não tendia a uma entropia máxima, para uma desordem geral. (...)<br>Mas nessa desordem incrível apareceram alguns princípios de ordem pelo menos os que fazem com que se constituam os núcleos, depois os átomos e as galáxias, o que faz com que, paradoxalmente, o mundo organize-se ao mesmo tempo em que se desintegra. Há uma espécie de luta entre um princípio de ordem e um de desordem, mas também uma espécie de cooperação entre ambos, cooperação da qual nasce uma idéia ausente na física clássica, que é a da organização.', 'os princípios aos que o autor se refere são os da ordem, da separação e da redução '),
(213, 61, '564', 'Num primeiro sentido, a palavra complexus significa \'o que está ligado, o que está tecido\'. E é esse tecido que é preciso conceber. Mas quando vemos as inúmeras interações que se fazem entre as células de nosso corpo e, no interior delas, entre as moléculas é evidente que não se pode ter nenhuma certeza sobre o que se passa localmente neste ou naquele ponto. A complexidade, portanto, devido justamente a estas interações, a estas retroações que ela contém (...) contribui também para uma maior incerteza. (...) A complexidade repousa ao mesmo tempo sobre o caráter de \'tecido\' e sobre a incerteza.', NULL),
...
(265, 80, '26', 'A comédia grega nasceu no mesmo berço em que se criaram as tragédias: as festas dionisíacas, em que o vinho entrava na veia dos manifestantes e corria como sangue ardente animando a mais tumultuada alegria.', NULL),
(266, 80, '10', 'As festas báquicas foram as primeiras representações teatrais, ainda inconscientes do sentido que continham. Baco, o deus boêmio, precisava de movimento, de alegria, de barulho, de máscaras, de paixões. Seus adeptos, guiados pelos sacerdotes, organizavam festas ao ar livre, com baile, vinhos, mulheres, a fim de proclamar-se o delírio, atributo do deus da alegria desenfreada (...) dos coros que animavam as danças nasceram a tragédia e a comédia.', NULL),
...
(311, 94, '15', 'Você coloca o fone de ouvido do ipod e consulta o maplink no palm enquanto ouve uma seleção de velhos sucessos de acid house com trip hop, electroclash e samba partido-alto. Em seguida envia pelo celular uma mensagem SMS pra ela, que vai se encarregar de enviar um recado para a lista de discussão depois que voltar do rafting da empresa. Em seguida passa na academia para uma aula de spinning e depois dá um pulo na Comic Store para comprar o último TP de Warren Ellis. Enquanto toma um café expresso ao lado, você acessa pelo palm o site de sua livraria preferida e descobre que acabou de chegar o último hardcover do Bruce Sterling; aproveita e faz o pedido da hora, debitando do cartão de crédito e com direito a um desconto por ser cliente preferencial -- é o que dizem os knowbots da livraria que reconhecem o seu perfil e ainda te recomendam de quebra um pocket do William Gibson que você já tem, mas eles não sabem disso porque você mandou vir do exterior por outra livraria. Aí você aproveita e atualiza seu blog com um post rápido sobre suas compras e dá uma olhada em alguns e-mails. Fica sabendo que uma blogueira amiga sua vai chegar do Rio amanhã no final da tarde e quer tomar um chope contigo. Você manda uma mensagem para o celular dela e acaba escrevendo uma mensagem rápida para a lista de discussão convidando quem quiser para o chope. Consulta o relógio (que, ao contrário do resto da sua parafernália, é comprado no camelô -- você foi assaltado meia dúzia de vezes e gato escaldado, you know) e vê que tem tempo de sobra. Você volta para casa, liga sua máquina e adianta uma matéria para um dos sites para os quais trabalha e logo em seguida faz uma busca na web por material relacionado à sua dissertação de mestrado sobre pós-humanidade. Bebida energética ao lado do computador e um livro de Donna Haraway no colo, você vara a noite e nem percebe. Amanhã tem mais.', NULL),
(312, 95, '348', 'In architecture, morphogenesis (digital morphogenesis or computacional morphogenesis) is understood as a group of methods that employ digital media not as representational tools for visualization but as generetive tools for the derivation of form and its transformation often in an aspiration to express contextual processes in built form. In this inclusive understanding, digital morphogenesis in architexture bears a largely analogous or metaphoric relationship to the processes of morphogenesis in nature, sharing with it the reliance on gradual development but not necessarily adopting or refering to the actual mechanisms of growth and adaptation.', 'Sobre a morfogênese, Gilfranco Alves, em sua qualificação, p. 69, nos diz:\r\nMais recentemente, o termo tem sido utilizado para designar uma abordagem de projeto que visa contestar a hegemonia de processos top-down de solução da forma, e substitui-la por uma lógica bottom-up de busca da forma. A ênfase passa a ser, portanto, no processo, onde o desempenho e o comportamento dos materiais tornaram-se centrais para a busca de aparência e do comportamento do produto final e os métodos de representação dos mesmos.\r\n\r\nRui: Na medida em que o processo projetual arquitetônico (isto é, o projeto de objetos físicos) também migra para o uso de dispositivos digitais, o processo adquire propriedades típicas do digital: a imaterialidade, a transmissão de informação via rede, a possibilidade de cooperação a distância, a não necessidade de versionamento, o eterno beta, a não necessidade de distribuição, etc. O processo ganha a possibilidade de se tornar Open Source. '),
...
(340, 103, '21', 'In short, the Maker Movement shares three characteristics, all of which, I’d argue, are transformative: <br>1. People using digital desktop tools to create designs for new products and prototype them (“digital DIY”).<br>2. A cultural norm to share those designs and collaborate with others in online communities.<br>3. The use of common design file standards that allow anyone, if they desire, to send their designs to commercial manufacturing services to be produced in any number, just as easily as they can fabricate them on their desktop.<br><br>This radically foreshortens the path from idea to entrepreneurship, just as the Web did in software, information, and content.', NULL),
...
(344, 104, '73', 'Somente no final do século XVIII e que foram criadas regras de propriedade para os textos, de direitos do autor e de reprodução, de relações entre autores e editores.', NULL),
(345, 104, '76', 'Segundo a autora, Barthes afirma que a crise da autoria teve início com Mallarmé, na medida em que este \'viu e previu em toda sua amplitude e necessidade de colocar a própria língua no lugar daquele que dela era até então considerado proprietário\', pois, quando falamos, é a linguagem que fala, age, performa', 'Ref. Barthes, ROLAND. Rumor da língua. São Paulo: Brasiliense. 1988. p. 65. '),
(346, 104, '81', 'Fazendo uso de recursos emergentes, começam a pipocar, por várias partes do mundo, projetos participativos que borram as linhas entre consumidor e produtor, com ênfase nas afiliações sociais e engajamento ativo.', NULL),
...
(356, 16, '11', 'O mito conta uma história sagrada: ele relata uma acontecimento ocorrido no tempo primordial (...) relata de que modo foi produzido ecomeçou a ser.', NULL),
(357, 31, '29', '(o modo de pensamento dos povos primitivos tem como finalidade) atingir pelos meios mais diminutos e econômicos uma compreensão geral do universo e não só uma compreensão geral, mas sim total. Isto é, trata-se de um modo de pensar que parte do princípio de que, se não se compreende tudo, não se pode explicar coisa alguma.', NULL),
(358, 1, '20', 'No mundo operatório, o cirurgião e o curandeiro ocupam os dois polos opostos (...) ao contrário do curandeiro, o cirurgião, no momento decisivo, renuncia a se comportar face ao doente de acordo com uma relação homem à homem; é sobretudo através do modo operatório que ele penetra no doente. Entre o pintor e o filmador encontramos a mesma relação existente entre o curandeiro e o cirurgião. O primeiro, pintando, observa uma distância natural entre a realidade dada e ele próprio; o filmador penetra em profundidade na própria estrutura do dado. As imagens que cada um obtém diferem extraordinariamente. A do pintor é global, a do filmador divide-se em um grande número de partes, onde cada qual obedece a suas leis próprias.', NULL),
(359, 12, '39', 'Os físicos sabem que seus métodos de análise e raciocínio lógico são incapazes de explicar de imediato a totalidade dos fenômenos naturais; assim, esses f´pisicos isolam um determinado grupo de fenômenos e tentam construir um modelo que descreva este grupo.', NULL),
(360, 12, '33', 'O método científico de abstração é bastante poderoso; temos, não obstante, de pagar um preço por este método. à medida em que definimos de forma mais precisa nosso sistema conceitual (...)(este) torna-se cada vez mais desligado do mundo real (...) Com a linguagem matemática, alcançamos um ponto onde os laços com a realidade se apresentam tão tênues que a relação entre os símbolos e nossa experiência sensorial não mais se faz evidente.', NULL),
(361, 25, '105', 'Kant ligou a doutrina do trabalhoso e ininterrupto progresso sem fim do pensar à insistência sobre a insuficiência e eterna limitação. A resposta que dou é um oráculo. Não há ser no mundo em que a ciência não possa penetrar, mas aquilo em que a ciência pode penetrar não é o ser. Segundo Kant, o juízo filosófico visa à novidade e contudo não conhece nada de novo, pois limita-se a repetir continuamente aquilo que a razão desde sempre implantou no objeto.', NULL),
(362, 5, '119', 'We must destroy in order that the lousy materialists may in the ruins recognise what is essencial (...) Dada wanted to destroy the rationalist swindle for man, and to incorporate him again humbly into nature. Dada wanted to change the perceptible world of man today inot a pious, senseless world without reason.', NULL),
(363, 2, '88', 'citando o Manifesto Comunista, <br>Todas as relações fixas, imobilizadas, com sua aura de idéias e opiniões veneráveis, são descartadas; todas as novas relações recém-formadas, se tornam obsoletas ates que se ossifiquem. Tudo o que é sólido desmancha no ar, tudo que é sagrado é profanado, e os homens são finalmente forçados a enfrentar com sentidos mais sóbrios suas reais condições de vida e sua relação com outros homens.', 'citando o Manifesto Comunista '),
(364, 13, '109', 'Este princípio (a metáfora), como se sabe, domina e impregan o conjunto do pensar mágico. Quem se tenha apoderado de qualquer parte do todo, dispõe também, com isso, no sentido mágido, do poder sobre o todo. (...)Os pitagóricos, ainda, observavam a prescrição de alisar o leitor após levantar-se, a fim de que a impressão do corpo sobre a cama não pudesse ser utilizada em detrimento da pessoa. A maioria das formas da assim chamada \'analogia mágica\' também brota desta visão fundamental; mas precisamente com isso mostram tis formas que, no seu caso, não se trata de simples analogia, e sim de identidade real.', ''),
...
(367, 110, '40', 'No caso da PUC-Rio, o aluno tem cinco disciplinas obrigatórias de projeto antes de chegar ao projeto final de graduação. Nelas -- pelo que pude observar ao longo de mais de 15 anos que trato com metodologia neste curso -- lhe é passada uma única maneira de segmentar o processo de projeto, através das etapas de geração de hipóteses, levantamento de dados, partido adotado, geração de alternativas, solução adotada e desenho final. O aluno acaba vendo este roteiro como o percurso único e final de seu universo de ação.', NULL),
(368, 110, '42', 'O primeiro momento de um trabalho de pesquisa, em qualquer nível, ocorre na própria mente. Representa, dessa maneira, uma fase abstrata. Nela, já utilizamos métodos de organização do pensamento. É um momento em que geramos a ideia daquilo que vamos fazer. é quando temos de, ou simplesmente vamos, decidir O QUE fazer. Identificamos uma necessidade ou simplesmente decidimos com o que trabalhar; confrontamos possibilidades e alternativas de temas e manifestamos intenções; levantamos questões, maneiras preliminares de realização e tentamos buscar razões para nossa opção. É nesse momento que pensamos em objetivos e justificativas eprimeiras e em possíveis planos investigatórios. Ao chegarmos à ideia, é bastante comum que a mesma venha acompanhada também de seus possíveis modos de realização.', NULL),
...
(460, 133, '35', '(...) a complexidade crescente de fatores envolvidos nos projetos de design não permite mais que o seu desenvolvimento se fundamente apenas na intuição ou na experiência adquirida.', NULL),
...
(608, 152, '1', 'And what the net seems to be doing is chipping away my capacity for concentration and contemplation.', NULL),
(609, 152, '3', 'Bruce Friedman, who blogs about the use of computers in medicine, has also described how the internet is altering his mental habits. \"I now have almost totally lost hte ability to read and absorb a lonish article on the web or in print\".', NULL),
...
(615, 152, '11', 'But my brain, I realized, wasn’t just drifting. It was hungry. It was demanding to be fed the way the Net fed it—and the more it was fed, the hungrier it became. Even when I was away from my computer, I yearned to check e-mail, click links, do some Googling. I wanted to be  connected.', NULL),
...
(636, 165, '83', 'O significado da expressão um tanto mística “o todo é mais que a soma das partes” consiste simplesmente em que as características constitutivas não são explicáveis a partir das características das partes isoladas. As características do complexo, portanto, comparadas às dos elementos, parecem “novas” ou “emergentes”. (...) Fisicamente, estes enunciados são triviais; mas podem tornar-se problemáticos e conduzir a concepções confusas em biologia, psicologia e sociologia somente por causa de uma interpretação errônea da concepção mecanicista, uma vez que existe a tendência para a resolução dos fenômenos em elementos independentes e cadeias causais, enquanto as inter-relações eram deixadas de lado.', NULL),
...
(35, 'similaridade'),
(206, 'simplificação'),
(100, 'simulação e simulacro'),
(187, 'sincronia entre problema e solução'),
(142, 'singularidade'),
...
(1, 'Textos Escolhidos', 'São Paulo', 'Abril Cultural', '1983', '', '', 'A obra de arte na época de suas técnicas de reprodução'),
(2, 'Tudo que é sólido desmancha no ar', 'São Paulo', 'Companhia das Letras', '1986', '', '', ''),
(3, 'Mitologia Grega', 'São Paulo', 'Vozes', '1991', '', '', ''),
(4, 'Mito e mitologia', 'Lisboa', 'Edições 70', '1991', '', '', ''),
(5, 'On my way: poetry and essays (1912 - 1947)', 'New York', 'Wittenborn & Company', '1948', '', '', ''),
(6, 'Esse ofício do verso', 'São Paulo', 'Companhia das Letras', '2000', '', '', ''),
(7, 'As núpcias de Cadmo e Harmonia', 'São Paulo', 'Companhia das Letras', '1990', '', '', ''),
(8, 'A imagem mítica', 'Campinas', 'Papirus', '1994', '', '', ''),
(9, 'O fim das certezas', 'São Paulo', 'Editora da UNESP', '1996', '', '', ''),
(10, 'The quark and the jaguar', 'London', ' Little Brown and Co', '1994', '', '', ''),
(12, 'O tao da física', 'São Paulo', 'Cultrix', '1983', '', '', ''),
(13, 'Linguagem e mito', 'São Paulo', 'Perspectiva', '1992', '', '', ''),
(14, 'A obra aberta', 'São Paulo', 'Perspectiva', '1976', '', '', ''),
(15, 'Mito do eterno retorno', 'São Paulo', 'Mercuryo', '1992', '', '', ''),
(16, 'Mito e realidade', 'São Paulo', 'Perspectiva', '1991', '', '', ''),
(17, 'sagrado e o profano', 'Lisboa', 'Livros do Brasil', '1992', '', '', ''),
...
(20, 'A mitologia grega', 'Sintra', 'Publicações Europa-América', '1986', '', '', ''),
(21, 'Emergence: from chaos to order', 'New York', 'Basic Books', '1999', '', '', ''),
(22, 'Roteiro para as novas mídias', 'São Paulo', 'SENAC', '2003', '', '', ''),
(24, 'Emergência: A dinâmica de rede em formigas, cérebros, cidades e softwares', 'Rio de Janeiro', 'Jorge Zahar Editor', '2003', '', '', ''),
(25, 'Textos Escolhidos', 'São Paulo', 'Abril Cultural', '1983', '', '', 'O conceito de Iluminismo'),
(26, 'Meaning in architecture', 'London', 'Barrie & Jenkins', '1970', '', '', ''),
(27, 'O homem e seus símbolos', 'Rio de Janeiro', 'Nova Fronteira', '1992', '', '', ''),
(28, 'A presença do mito', 'Brasília', 'Editora Universidade de Brasília', '1972', '', '', ''),
(29, 'A arte do romance', 'Rio de Janeiro', 'Nova Fronteira', '1998', '', '', ''),
(30, 'Antropologia Estrutural', 'Rio de Janeiro', 'Tempo Brasileiro', '1989', '', '', ''),
(31, 'Mito e sinificado', 'Lisboa', 'Edições 70', '2000', '', '', ''),
(33, 'O conhecimento comum', 'São Paulo', 'Jornal Folha de São Paulo', '', '', '20 de agosto de 1988', ''),
(34, 'O elogio dos intelectuais', 'São Paulo', 'Jornal Folha de São Paulo', '0', '', '6 de agosto de 1988', ''),
(35, 'O homem, uma introdução à antropologia', 'São Paulo', 'Martins Fontes', '1981', '', '', ''),
...
(41, 'O mito', 'São Paulo', 'Perspectiva', '1997', '', '', ''),
(42, 'History of the western philosophy', 'London', 'Routledge', '2000', '', '', ''),
(43, 'Signos em rotação', 'São Paulo', 'Perspectiva', '1976', '', '', ''),
(44, 'Da vanguarda ao pós moderno', 'São Paulo', 'Nobel', '1984', '', '', ''),
(45, 'Information architecture', 'Sebastopol', 'O\'Reilly Media Inc', '2002', '', '', ''),
(46, 'Design: história, teoria e prática do design de produtos', 'São Paulo', 'Edgard Blücher', '2006', '', '', ''),
(48, 'Introdução ao pensamento complexo', 'Lisboa', 'Instituto Piaget', '2003', '', '', ''),
(51, 'Design Método', 'Rio de Janeiro', 'Ed. PUC Rio', '2006', '', '', 'Por uma cultura do método: algumas reflexões da disciplina de questões metodológicas.'),
...
(55, 'História do cinema mundial', 'Campinas', 'Papirus', '2006', '', '', 'Cinema pós-moderno'),
...
(60, 'Condição pós-moderna', 'São Paulo', 'Edições Loyola', '1996', '', '', ''),
(61, 'A religação dos saberes', 'Rio de Janeiro', 'Bertrand Brasil', '2002', '', '', 'Os desafios da complexidade'),
...
(80, 'Teatro grego', 'São Paulo', 'Paumape', '1993', '', '', ''),
...
(94, 'A construção do imaginário cyber', 'São Paulo', 'Editora Anhembi Morumbi', '2006', '', '', ''),
(95, 'International Journal of Architectural Computing', '', '', '2009', 'http://bit.ly/TmT2mA', 'novembro de 2012', 'Towards morphogenesis in architecture'),
...
(104, 'Linguagens líquidas na era da mobilidade', 'São Paulo', 'Paulus', '2007', '', '', ''),
...
(110, 'Design Método', 'Rio de Janeiro', 'PUC RJ', '2006', '', '', 'Por uma metodologia de idéias'),
...
(125, 'Das coisas nascem coisas', 'Lisboa', 'Edições 70', '1981', '', '', ''),
...
(133, 'Design Método', 'Rio de Janeiro', 'Ed. PUC Rio', '2006', '', '', 'Sobre métodos de design'),
...
(165, 'Teoria geral dos sistemas', 'São Paulo', 'Vozes', '2016', '', '', ''),
...
(1, 'ruialao', 'Rui Alão', 'a745c7f739cba6e02ca11af330377cf09db32e6cbb9a86ed586842b1fc72d5ed', 1),
...
ALTER TABLE `citacao` ADD FULLTEXT KEY `resourcemetadataText` (`CitCitacao`);

--
-- Índices de tabela `cit_pal`
--
ALTER TABLE `cit_pal`
  ADD KEY `resourcekeywordKeywordId` (`IdPalavra`);
...
ALTER TABLE `palavra`
  ...
  ADD KEY `keywordKeyword` (`PalPalavra`);
...
--
ALTER TABLE `autor`
  MODIFY `IdAutor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=196;

--
-- AUTO_INCREMENT de tabela `citacao`
--
ALTER TABLE `citacao`
  MODIFY `IdCitacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=785;

--
-- AUTO_INCREMENT de tabela `palavra`
--
ALTER TABLE `palavra`
  MODIFY `IdPalavra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=279;

--
-- AUTO_INCREMENT de tabela `publicacao`
--
ALTER TABLE `publicacao`
  MODIFY `IdPublicacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=169;
