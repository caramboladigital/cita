...
(788, 169, '26', 'Donec elementum, eros at scelerisque tincidunt, justo risus efficitur tortor, at dignissim dui leo ut urna. Fusce non dui in nunc cursus varius ac quis lorem. Mauris sed risus leo. Quisque non sapien nunc. Pellentesque eu tellus eu nibh pulvinar interdum. Aliquam erat volutpat. Praesent venenatis sit amet nisl quis pellentesque. Nulla risus massa, scelerisque quis sem quis, placerat laoreet urna. Aliquam pulvinar, velit in tristique convallis, dui elit congue nibh, ut venenatis turpis nisi non ligula. Praesent ut convallis odio. Nunc sit amet tortor mattis, pharetra leo sit amet, vulputate dolor.', '');
...
CREATE TABLE `lingua` (
  ...
  `ptBR` text COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `enGB` text COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `esES` text COLLATE utf8mb4_unicode_520_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

--
-- Despejando dados para a tabela `lingua`
--
...
(122, 'Crowdsourcing: The Coming Big Bang of Business and How It Will Change Your World', 'New York', 'Random House Inc', '2008', '', '', ''),
...
(169, 'A livrada na cara', 'São Paulo', 'Edições 70', '2000', '', '', '');
...
CREATE TABLE `usuario` (
  ...
  `UsuLingua` varchar(6) CHARACTER SET utf8 COLLATE utf8_unicode_520_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
...
--
ALTER TABLE `cit_pal`
  ADD PRIMARY KEY (`IdPalavra`,`IdCitacao`);

--
-- Índices de tabela `lingua`
--
ALTER TABLE `lingua`
